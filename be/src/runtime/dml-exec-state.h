...
class InsertExecStatusPB;
class InsertPartitionStatusPB;
class InsertStatsPB;
class TInsertResult;
...
class DmlExecState {
 public:
  ...
  void Update(const InsertExecStatusPB& dml_exec_status);
  ...
  void ToProto(InsertExecStatusPB* dml_status);
 ...
 private:
  ...
  typedef std::map<std::string, InsertPartitionStatusPB> PartitionStatusMap;
  ...
  void MergeDmlStats(const InsertStatsPB& src, InsertStatsPB* dst);
};
