...
class Callback<R(void)> : public internal::CallbackBase {
 public:
  ...
  Callback(internal::BindState<Runnable, BindRunType, BoundArgsType>* bind_state)
    : CallbackBase(bind_state) {
    // Force the assignment to a local variable of PolymorphicInvoke
    // so the compiler will typecheck that the passed in Run() method has
    // the correct type.
    PolymorphicInvoke invoke_func =
        &internal::BindState<Runnable, BindRunType, BoundArgsType>::InvokerType::Run;
...
class Callback<R(A1)> : public internal::CallbackBase {
 ...
 private:
  typedef R (*PolymorphicInvoke)(
      internal::BindStateBase*, typename internal::CallbackParamTraits<A1>::ForwardType);
};
...
class Callback<R(A1, A2)> : public internal::CallbackBase {
 public:
  ...
  R Run(typename internal::CallbackParamTraits<A1>::ForwardType a1,
    ...
    return f(
        bind_state_.get(), internal::CallbackForward(a1), internal::CallbackForward(a2));
  }
...
class Callback<R(A1, A2, A3)> : public internal::CallbackBase {
 public:
  ...
  R Run(typename internal::CallbackParamTraits<A1>::ForwardType a1,
    ...
    return f(bind_state_.get(), internal::CallbackForward(a1),
        internal::CallbackForward(a2), internal::CallbackForward(a3));
  }
...
class Callback<R(A1, A2, A3, A4, A5)> : public internal::CallbackBase {
 public:
  ...
  R Run(typename internal::CallbackParamTraits<A1>::ForwardType a1,
    ...
    return f(bind_state_.get(), internal::CallbackForward(a1),
        internal::CallbackForward(a2), internal::CallbackForward(a3),
        internal::CallbackForward(a4), internal::CallbackForward(a5));
  }
 ...
 public:
  ...
  R Run(typename internal::CallbackParamTraits<A1>::ForwardType a1,
    ...
    return f(bind_state_.get(), internal::CallbackForward(a1),
        internal::CallbackForward(a2), internal::CallbackForward(a3),
        internal::CallbackForward(a4), internal::CallbackForward(a5),
        internal::CallbackForward(a6), internal::CallbackForward(a7));
  }
