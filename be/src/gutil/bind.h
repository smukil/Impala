...
Callback<
    typename internal::BindState<typename internal::FunctorTraits<Functor>::RunnableType,
        typename internal::FunctorTraits<Functor>::RunType, void()>::UnboundRunType>
...
Callback<
    typename internal::BindState<typename internal::FunctorTraits<Functor>::RunnableType,
        ...
        void(typename internal::CallbackParamTraits<P1>::StorageType)>::UnboundRunType>
Bind(Functor functor, const P1& p1) {
  ...
  typedef internal::FunctionTraits<typename RunnableType::RunType> BoundFunctorTraits;
  ...
  COMPILE_ASSERT(
      !(base::is_non_const_reference<typename BoundFunctorTraits::A1Type>::value),
  ...
  COMPILE_ASSERT(
      !internal::HasIsMethodTag<RunnableType>::value || !base::is_array<P1>::value,
...
Callback<typename internal::BindState<
    ...
    typename internal::FunctorTraits<Functor>::RunType,
    void(typename internal::CallbackParamTraits<P1>::StorageType,
        typename internal::CallbackParamTraits<P2>::StorageType)>::UnboundRunType>
Bind(Functor functor, const P1& p1, const P2& p2) {
  ...
  COMPILE_ASSERT(
      !(base::is_non_const_reference<typename BoundFunctorTraits::A1Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A2Type>::value),
      do_not_bind_functions_with_nonconst_ref);
  ...
  typedef internal::
      BindState<RunnableType, RunType,
          void(typename internal::CallbackParamTraits<P1>::StorageType,
...
Callback<typename internal::BindState<
    ...
    void(typename internal::CallbackParamTraits<P1>::StorageType,
        typename internal::CallbackParamTraits<P2>::StorageType,
        typename internal::CallbackParamTraits<P3>::StorageType)>::UnboundRunType>
Bind(Functor functor, const P1& p1, const P2& p2, const P3& p3) {
  ...
  COMPILE_ASSERT(
      !(base::is_non_const_reference<typename BoundFunctorTraits::A1Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A2Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A3Type>::value),
      do_not_bind_functions_with_nonconst_ref);
...
Callback<typename internal::BindState<
    ...
    void(typename internal::CallbackParamTraits<P1>::StorageType,
        typename internal::CallbackParamTraits<P2>::StorageType,
        typename internal::CallbackParamTraits<P3>::StorageType,
        typename internal::CallbackParamTraits<P4>::StorageType)>::UnboundRunType>
Bind(Functor functor, const P1& p1, const P2& p2, const P3& p3, const P4& p4) {
  ...
  COMPILE_ASSERT(
      !(base::is_non_const_reference<typename BoundFunctorTraits::A1Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A2Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A3Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A4Type>::value),
      do_not_bind_functions_with_nonconst_ref);
...
Callback<typename internal::BindState<
    ...
    void(typename internal::CallbackParamTraits<P1>::StorageType,
        ...
        typename internal::CallbackParamTraits<P3>::StorageType,
        typename internal::CallbackParamTraits<P4>::StorageType,
        typename internal::CallbackParamTraits<P5>::StorageType)>::UnboundRunType>
Bind(Functor functor, const P1& p1, const P2& p2, const P3& p3, const P4& p4,
    const P5& p5) {
  // Typedefs for how to store and run the functor.
  typedef typename internal::FunctorTraits<Functor>::RunnableType RunnableType;
  ...
  COMPILE_ASSERT(
      !(base::is_non_const_reference<typename BoundFunctorTraits::A1Type>::value
          ...
          || base::is_non_const_reference<typename BoundFunctorTraits::A3Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A4Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A5Type>::value),
      do_not_bind_functions_with_nonconst_ref);
...
Callback<typename internal::BindState<
    ...
    void(typename internal::CallbackParamTraits<P1>::StorageType,
        ...
        typename internal::CallbackParamTraits<P4>::StorageType,
        typename internal::CallbackParamTraits<P5>::StorageType,
        typename internal::CallbackParamTraits<P6>::StorageType)>::UnboundRunType>
Bind(Functor functor, const P1& p1, const P2& p2, const P3& p3, const P4& p4,
  ...
  COMPILE_ASSERT(
      !(base::is_non_const_reference<typename BoundFunctorTraits::A1Type>::value
          ...
          || base::is_non_const_reference<typename BoundFunctorTraits::A4Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A5Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A6Type>::value),
      do_not_bind_functions_with_nonconst_ref);
...
Callback<typename internal::BindState<
    ...
    void(typename internal::CallbackParamTraits<P1>::StorageType,
        ...
        typename internal::CallbackParamTraits<P5>::StorageType,
        typename internal::CallbackParamTraits<P6>::StorageType,
        typename internal::CallbackParamTraits<P7>::StorageType)>::UnboundRunType>
Bind(Functor functor, const P1& p1, const P2& p2, const P3& p3, const P4& p4,
  ...
  COMPILE_ASSERT(
      !(base::is_non_const_reference<typename BoundFunctorTraits::A1Type>::value
          ...
          || base::is_non_const_reference<typename BoundFunctorTraits::A5Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A6Type>::value
          || base::is_non_const_reference<typename BoundFunctorTraits::A7Type>::value),
      do_not_bind_functions_with_nonconst_ref);
