...
static void AtomicOps_Internalx86CPUFeaturesInit() {
  ...
  VLOG(1) << "vendor " << vendor << "  family " << family << "  model " << model
          << "  amd_lock_mb_bug " << AtomicOps_Internalx86CPUFeatures.has_amd_lock_mb_bug
          << "  sse2 " << AtomicOps_Internalx86CPUFeatures.has_sse2 << "  cmpxchg16b "
          << AtomicOps_Internalx86CPUFeatures.has_cmpxchg16b;
}
