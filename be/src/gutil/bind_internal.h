...
class RunnableAdapter<R (T::*)(A1, A2, A3) const> {
 public:
  ...
  explicit RunnableAdapter(R (T::*method)(A1, A2, A3) const) : method_(method) {}
...
class RunnableAdapter<R (*)(A1, A2, A3, A4)> {
 public:
  ...
  explicit RunnableAdapter(R (*function)(A1, A2, A3, A4)) : function_(function) {}
...
class RunnableAdapter<R (T::*)(A1, A2, A3, A4) const> {
 public:
  ...
  explicit RunnableAdapter(R (T::*method)(A1, A2, A3, A4) const) : method_(method) {}
...
class RunnableAdapter<R (*)(A1, A2, A3, A4, A5)> {
 public:
  ...
  explicit RunnableAdapter(R (*function)(A1, A2, A3, A4, A5)) : function_(function) {}
...
class RunnableAdapter<R (T::*)(A1, A2, A3, A4, A5)> {
 public:
  ...
  explicit RunnableAdapter(R (T::*method)(A1, A2, A3, A4, A5)) : method_(method) {}
...
class RunnableAdapter<R (T::*)(A1, A2, A3, A4, A5) const> {
 public:
  ...
  explicit RunnableAdapter(R (T::*method)(A1, A2, A3, A4, A5) const) : method_(method) {}
...
class RunnableAdapter<R (*)(A1, A2, A3, A4, A5, A6)> {
 public:
  ...
  explicit RunnableAdapter(R (*function)(A1, A2, A3, A4, A5, A6)) : function_(function) {}
...
class RunnableAdapter<R (T::*)(A1, A2, A3, A4, A5, A6)> {
 public:
  ...
  explicit RunnableAdapter(R (T::*method)(A1, A2, A3, A4, A5, A6)) : method_(method) {}
...
struct InvokeHelper<false, void, Runnable, void(A1)> {
  static void MakeItSo(Runnable runnable, A1 a1) { runnable.Run(CallbackForward(a1)); }
};
...
struct InvokeHelper<false, ReturnType, Runnable, void(A1, A2, A3, A4, A5, A6)> {
  static ReturnType MakeItSo(
      Runnable runnable, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6) {
    return runnable.Run(CallbackForward(a1), CallbackForward(a2), CallbackForward(a3),
        CallbackForward(a4), CallbackForward(a5), CallbackForward(a6));
  }
};
...
struct InvokeHelper<false, ReturnType, Runnable, void(A1, A2, A3, A4, A5, A6, A7)> {
  static ReturnType MakeItSo(
      Runnable runnable, A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7) {
    return runnable.Run(CallbackForward(a1), CallbackForward(a2), CallbackForward(a3),
        CallbackForward(a4), CallbackForward(a5), CallbackForward(a6),
        CallbackForward(a7));
  }
...
struct Invoker<0, StorageType, R(X1)> {
  ...
  static R Run(BindStateBase* base, typename CallbackParamTraits<X1>::ForwardType x1) {
    ...
    return InvokeHelper<StorageType::IsWeakCall::value, R,
        ...
        void(typename CallbackParamTraits<X1>::ForwardType x1)>::MakeItSo(storage
                                                                              ->runnable_,
        CallbackForward(x1));
  }
};
...
struct Invoker<1, StorageType, R(X1)> {
  ...
  static R Run(BindStateBase* base) {
    ...
    return InvokeHelper<StorageType::IsWeakCall::value, R,
        typename StorageType::RunnableType,
        void(typename Bound1UnwrapTraits::ForwardType)>::MakeItSo(storage->runnable_,
        CallbackForward(x1));
  }
};
  ...
  static R Run(BindStateBase* base, typename CallbackParamTraits<X1>::ForwardType x1,
    ...
    return InvokeHelper<StorageType::IsWeakCall::value, R,
        ...
        void(typename CallbackParamTraits<X1>::ForwardType x1,
                            typename CallbackParamTraits<X2>::ForwardType
                                x2)>::MakeItSo(storage->runnable_, CallbackForward(x1),
        CallbackForward(x2));
  }
};
...
// Arity 3 -> 3.
template <typename StorageType, typename R, typename X1, typename X2, typename X3>
  ...
  static R Run(BindStateBase* base, typename CallbackParamTraits<X1>::ForwardType x1,
    ...
    return InvokeHelper<StorageType::IsWeakCall::value, R,
        ...
        void(typename CallbackParamTraits<X1>::ForwardType x1,
                            typename CallbackParamTraits<X2>::ForwardType x2,
                            typename CallbackParamTraits<X3>::ForwardType
                                x3)>::MakeItSo(storage->runnable_, CallbackForward(x1),
  ...
  static R Run(BindStateBase* base, typename CallbackParamTraits<X1>::ForwardType x1,
    ...
    return InvokeHelper<StorageType::IsWeakCall::value, R,
        ...
        void(typename CallbackParamTraits<X1>::ForwardType x1,
                            ...
                            typename CallbackParamTraits<X3>::ForwardType x3,
                            typename CallbackParamTraits<X4>::ForwardType
                                x4)>::MakeItSo(storage->runnable_, CallbackForward(x1),
        CallbackForward(x2), CallbackForward(x3), CallbackForward(x4));
  }
};
...
struct Invoker<0, StorageType, R(X1, X2, X3, X4, X5, X6)> {
  ...
  static R Run(BindStateBase* base, typename CallbackParamTraits<X1>::ForwardType x1,
    ...
    return InvokeHelper<StorageType::IsWeakCall::value, R,
        ...
        CallbackForward(x2), CallbackForward(x3), CallbackForward(x4),
        CallbackForward(x5), CallbackForward(x6));
  }
};
...
struct Invoker<0, StorageType, R(X1, X2, X3, X4, X5, X6, X7)> {
  ...
  static R Run(BindStateBase* base, typename CallbackParamTraits<X1>::ForwardType x1,
    ...
    return InvokeHelper<StorageType::IsWeakCall::value, R,
        ...
        CallbackForward(x2), CallbackForward(x3), CallbackForward(x4),
        CallbackForward(x5), CallbackForward(x6), CallbackForward(x7));
  }
};
...
struct BindState<Runnable, RunType, void(P1, P2, P3, P4, P5, P6)> : public BindStateBase {
  ...
  BindState(const Runnable& runnable, const P1& p1, const P2& p2, const P3& p3,
    ...
    : runnable_(runnable), p1_(p1), p2_(p2), p3_(p3), p4_(p4), p5_(p5), p6_(p6) {
    MaybeRefcount<HasIsMethodTag<Runnable>::value, P1>::AddRef(p1_);
  }
...
struct BindState<Runnable, RunType, void(P1, P2, P3, P4, P5, P6, P7)>
  ...
  BindState(const Runnable& runnable, const P1& p1, const P2& p2, const P3& p3,
    ...
    : runnable_(runnable), p1_(p1), p2_(p2), p3_(p3), p4_(p4), p5_(p5), p6_(p6), p7_(p7) {
    MaybeRefcount<HasIsMethodTag<Runnable>::value, P1>::AddRef(p1_);
  }
