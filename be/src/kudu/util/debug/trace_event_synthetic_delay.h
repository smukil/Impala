...
class TRACE_EVENT_API_CLASS_EXPORT TraceEventSyntheticDelay {
 ...
 private:
  ...
  void Initialize(const std::string& name, TraceEventSyntheticDelayClock* clock);
...
TRACE_EVENT_API_CLASS_EXPORT kudu::debug::TraceEventSyntheticDelay* GetOrCreateDelay(
