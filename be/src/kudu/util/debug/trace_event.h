...
#define UNSHIPPED_TRACE_EVENT1(category_group, name, arg1_name, arg1_val) (void)0
#define UNSHIPPED_TRACE_EVENT2(                                     \
    category_group, name, arg1_name, arg1_val, arg2_name, arg2_val) \
  (void)0
#define UNSHIPPED_TRACE_EVENT_INSTANT0(category_group, name, scope) (void)0
#define UNSHIPPED_TRACE_EVENT_INSTANT1(category_group, name, scope, arg1_name, arg1_val) \
  (void)0
#define UNSHIPPED_TRACE_EVENT_INSTANT2(                                    \
    category_group, name, scope, arg1_name, arg1_val, arg2_name, arg2_val) \
  (void)0
#else
#define UNSHIPPED_TRACE_EVENT0(category_group, name) TRACE_EVENT0(category_group, name)
...
#define TRACE_EVENT_INSTANT2(                                               \
    category_group, name, scope, arg1_name, arg1_val, arg2_name, arg2_val)  \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_INSTANT, category_group, name, \
      TRACE_EVENT_FLAG_NONE | scope, arg1_name, arg1_val, arg2_name, arg2_val)
#define TRACE_EVENT_COPY_INSTANT0(category_group, name, scope) \
  INTERNAL_TRACE_EVENT_ADD(                                    \
      TRACE_EVENT_PHASE_INSTANT, category_group, name, TRACE_EVENT_FLAG_COPY | scope)
...
#define TRACE_EVENT_COPY_INSTANT2(                                          \
    category_group, name, scope, arg1_name, arg1_val, arg2_name, arg2_val)  \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_INSTANT, category_group, name, \
      TRACE_EVENT_FLAG_COPY | scope, arg1_name, arg1_val, arg2_name, arg2_val)
...
#define TRACE_EVENT_BEGIN_WITH_ID_TID_AND_TIMESTAMP0(                               \
  ...
  INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(TRACE_EVENT_PHASE_ASYNC_BEGIN, \
      category_group, name, id, thread_id, timestamp, TRACE_EVENT_FLAG_NONE)
#define TRACE_EVENT_COPY_BEGIN_WITH_ID_TID_AND_TIMESTAMP0(                          \
    category_group, name, id, thread_id, timestamp)                                 \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(TRACE_EVENT_PHASE_ASYNC_BEGIN, \
      category_group, name, id, thread_id, timestamp, TRACE_EVENT_FLAG_COPY)
...
#define TRACE_EVENT_END_WITH_ID_TID_AND_TIMESTAMP0(                               \
    category_group, name, id, thread_id, timestamp)                               \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(TRACE_EVENT_PHASE_ASYNC_END, \
      category_group, name, id, thread_id, timestamp, TRACE_EVENT_FLAG_NONE)
...
#define TRACE_COUNTER2(                                                              \
  ...
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_COUNTER, category_group, name,          \
      TRACE_EVENT_FLAG_NONE, value1_name, static_cast<int>(value1_val), value2_name, \
      static_cast<int>(value2_val))
#define TRACE_COPY_COUNTER2(                                                         \
    category_group, name, value1_name, value1_val, value2_name, value2_val)          \
  INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_COUNTER, category_group, name,          \
      TRACE_EVENT_FLAG_COPY, value1_name, static_cast<int>(value1_val), value2_name, \
      static_cast<int>(value2_val))
...
#define TRACE_COUNTER_ID1(category_group, name, id, value)                              \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_COUNTER, category_group, name, id, \
      TRACE_EVENT_FLAG_NONE, "value", static_cast<int>(value))
...
#define TRACE_COUNTER_ID2(                                                              \
    category_group, name, id, value1_name, value1_val, value2_name, value2_val)         \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_COUNTER, category_group, name, id, \
      TRACE_EVENT_FLAG_NONE, value1_name, static_cast<int>(value1_val), value2_name,    \
      static_cast<int>(value2_val))
...
#define TRACE_EVENT_ASYNC_BEGIN1(category_group, name, id, arg1_name, arg1_val)         \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_ASYNC_BEGIN, category_group, name, \
      id, TRACE_EVENT_FLAG_NONE, arg1_name, arg1_val)
#define TRACE_EVENT_ASYNC_BEGIN2(                                                       \
    category_group, name, id, arg1_name, arg1_val, arg2_name, arg2_val)                 \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_ASYNC_BEGIN, category_group, name, \
      id, TRACE_EVENT_FLAG_NONE, arg1_name, arg1_val, arg2_name, arg2_val)
#define TRACE_EVENT_COPY_ASYNC_BEGIN0(category_group, name, id) \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(                             \
      TRACE_EVENT_PHASE_ASYNC_BEGIN, category_group, name, id, TRACE_EVENT_FLAG_COPY)
...
#define TRACE_EVENT_COPY_ASYNC_BEGIN2(                                                  \
    category_group, name, id, arg1_name, arg1_val, arg2_name, arg2_val)                 \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_ASYNC_BEGIN, category_group, name, \
      id, TRACE_EVENT_FLAG_COPY, arg1_name, arg1_val, arg2_name, arg2_val)
...
#define TRACE_EVENT_ASYNC_STEP_INTO0(category_group, name, id, step)                  \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_ASYNC_STEP_INTO, category_group, \
      name, id, TRACE_EVENT_FLAG_NONE, "step", step)
#define TRACE_EVENT_ASYNC_STEP_INTO1(                                                 \
    category_group, name, id, step, arg1_name, arg1_val)                              \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_ASYNC_STEP_INTO, category_group, \
      name, id, TRACE_EVENT_FLAG_NONE, "step", step, arg1_name, arg1_val)
...
#define TRACE_EVENT_ASYNC_STEP_PAST0(category_group, name, id, step)                  \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_ASYNC_STEP_PAST, category_group, \
      name, id, TRACE_EVENT_FLAG_NONE, "step", step)
...
#define TRACE_EVENT_ASYNC_END1(category_group, name, id, arg1_name, arg1_val)         \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_ASYNC_END, category_group, name, \
      id, TRACE_EVENT_FLAG_NONE, arg1_name, arg1_val)
...
#define TRACE_EVENT_COPY_ASYNC_END0(category_group, name, id) \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(                           \
      TRACE_EVENT_PHASE_ASYNC_END, category_group, name, id, TRACE_EVENT_FLAG_COPY)
...
#define TRACE_EVENT_FLOW_BEGIN0(category_group, name, id) \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(                       \
      TRACE_EVENT_PHASE_FLOW_BEGIN, category_group, name, id, TRACE_EVENT_FLAG_NONE)
#define TRACE_EVENT_FLOW_BEGIN1(category_group, name, id, arg1_name, arg1_val)         \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_FLOW_BEGIN, category_group, name, \
      id, TRACE_EVENT_FLAG_NONE, arg1_name, arg1_val)
...
#define TRACE_EVENT_COPY_FLOW_BEGIN0(category_group, name, id) \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(                            \
      TRACE_EVENT_PHASE_FLOW_BEGIN, category_group, name, id, TRACE_EVENT_FLAG_COPY)
...
#define TRACE_EVENT_FLOW_STEP0(category_group, name, id, step)                        \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_FLOW_STEP, category_group, name, \
...
#define TRACE_EVENT_COPY_FLOW_END0(category_group, name, id) \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(                          \
      TRACE_EVENT_PHASE_FLOW_END, category_group, name, id, TRACE_EVENT_FLAG_COPY)
...
#define TRACE_EVENT_OBJECT_CREATED_WITH_ID(category_group, name, id)                \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_CREATE_OBJECT, category_group, \
      name, TRACE_ID_DONT_MANGLE(id), TRACE_EVENT_FLAG_NONE)

#define TRACE_EVENT_OBJECT_SNAPSHOT_WITH_ID(category_group, name, id, snapshot)       \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_SNAPSHOT_OBJECT, category_group, \
      name, TRACE_ID_DONT_MANGLE(id), TRACE_EVENT_FLAG_NONE, "snapshot", snapshot)

#define TRACE_EVENT_OBJECT_DELETED_WITH_ID(category_group, name, id)                \
  INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_DELETE_OBJECT, category_group, \
      name, TRACE_ID_DONT_MANGLE(id), TRACE_EVENT_FLAG_NONE)
...
#define TRACE_EVENT_IS_NEW_TRACE(ret)                                              \
  do {                                                                             \
    ...
    if (num_traces_recorded != -1                                                  \
        && num_traces_recorded != INTERNAL_TRACE_EVENT_UID(lastRecordingNumber)) { \
...
#define TRACE_EVENT_API_THREAD_BUCKET(thread_bucket) g_trace_state[thread_bucket]
...
#define INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO_CUSTOM_VARIABLES(                         \
  ...
  category_group_enabled =                                                               \
      reinterpret_cast<const unsigned char*>(TRACE_EVENT_API_ATOMIC_LOAD(atomic));       \
...
#define INTERNAL_TRACE_EVENT_ADD(phase, category_group, name, flags, ...)   \
  do {                                                                      \
    INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO(category_group);                 \
    if (INTERNAL_TRACE_EVENT_CATEGORY_GROUP_ENABLED_FOR_RECORDING_MODE()) { \
      trace_event_internal::AddTraceEvent(phase,                            \
...
#define INTERNAL_TRACE_EVENT_ADD_SCOPED(category_group, name, ...)                     \
  ...
  if (INTERNAL_TRACE_EVENT_CATEGORY_GROUP_ENABLED_FOR_RECORDING_MODE()) {              \
    kudu::debug::TraceEventHandle h = trace_event_internal::AddTraceEvent(             \
        ...
        name, trace_event_internal::kNoEventId, TRACE_EVENT_FLAG_NONE, ##__VA_ARGS__); \
    INTERNAL_TRACE_EVENT_UID(tracer)                                                   \
        .Initialize(INTERNAL_TRACE_EVENT_UID(category_group_enabled), name, h);        \
  }
...
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID(phase, category_group, name, id, flags, ...) \
  do {                                                                                \
    ...
    if (INTERNAL_TRACE_EVENT_CATEGORY_GROUP_ENABLED_FOR_RECORDING_MODE()) {           \
      ...
      trace_event_internal::TraceID trace_event_trace_id(id, &trace_event_flags);     \
      trace_event_internal::AddTraceEvent(phase,                                      \
          INTERNAL_TRACE_EVENT_UID(category_group_enabled), name,                     \
...
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(                       \
  ...
  do {                                                                            \
    ...
    if (INTERNAL_TRACE_EVENT_CATEGORY_GROUP_ENABLED_FOR_RECORDING_MODE()) {       \
      unsigned char trace_event_flags = flags | TRACE_EVENT_FLAG_HAS_ID;          \
      trace_event_internal::TraceID trace_event_trace_id(id, &trace_event_flags); \
      trace_event_internal::AddTraceEventWithThreadIdAndTimestamp(phase,          \
          INTERNAL_TRACE_EVENT_UID(category_group_enabled), name,                 \
          trace_event_trace_id.data(), thread_id, timestamp, trace_event_flags,   \
          ##__VA_ARGS__);                                                         \
    }                                                                             \
  } while (0)
...
INTERNAL_DECLARE_SET_TRACE_VALUE(double, arg, as_double, TRACE_VALUE_TYPE_DOUBLE)
INTERNAL_DECLARE_SET_TRACE_VALUE(const void*, arg, as_pointer, TRACE_VALUE_TYPE_POINTER)
INTERNAL_DECLARE_SET_TRACE_VALUE(const char*, arg, as_string, TRACE_VALUE_TYPE_STRING)
INTERNAL_DECLARE_SET_TRACE_VALUE(
    const TraceStringWithCopy&, arg.str(), as_string, TRACE_VALUE_TYPE_COPY_STRING)
...
static inline void SetTraceValue(
    const std::string& arg, unsigned char* type, uint64_t* value) {
  TraceValueUnion type_value;
...
static inline kudu::debug::TraceEventHandle AddTraceEventWithThreadIdAndTimestamp(
    char phase, const unsigned char* category_group_enabled, const char* name,
    uint64_t id, int thread_id, const MicrosecondsInt64& timestamp, unsigned char flags,
    const char* arg1_name,
    const scoped_refptr<kudu::debug::ConvertableToTraceFormat>& arg1_val) {
  const int num_args = 1;
  unsigned char arg_types[1] = {TRACE_VALUE_TYPE_CONVERTABLE};
  return TRACE_EVENT_API_ADD_TRACE_EVENT_WITH_THREAD_ID_AND_TIMESTAMP(phase,
      category_group_enabled, name, id, thread_id, timestamp, num_args, &arg1_name,
      arg_types, NULL, &arg1_val, flags);
}
...
static inline kudu::debug::TraceEventHandle AddTraceEventWithThreadIdAndTimestamp(
  ...
  return TRACE_EVENT_API_ADD_TRACE_EVENT_WITH_THREAD_ID_AND_TIMESTAMP(phase,
      category_group_enabled, name, id, thread_id, timestamp, num_args, arg_names,
...
static inline kudu::debug::TraceEventHandle AddTraceEventWithThreadIdAndTimestamp(
  ...
  return TRACE_EVENT_API_ADD_TRACE_EVENT_WITH_THREAD_ID_AND_TIMESTAMP(phase,
      category_group_enabled, name, id, thread_id, timestamp, num_args, arg_names,
      arg_types, NULL, convertable_values, flags);
}
...
static inline kudu::debug::TraceEventHandle AddTraceEventWithThreadIdAndTimestamp(
    ...
    uint64_t id, int thread_id, const MicrosecondsInt64& timestamp, unsigned char flags) {
  return TRACE_EVENT_API_ADD_TRACE_EVENT_WITH_THREAD_ID_AND_TIMESTAMP(phase,
      category_group_enabled, name, id, thread_id, timestamp, kZeroNumArgs, NULL, NULL,
      NULL, NULL, flags);
}

static inline kudu::debug::TraceEventHandle AddTraceEvent(char phase,
...
static inline kudu::debug::TraceEventHandle AddTraceEvent(char phase,
  ...
  return AddTraceEventWithThreadIdAndTimestamp(phase, category_group_enabled, name, id,
      thread_id, now, flags, arg1_name, arg1_val);
}
...
static inline kudu::debug::TraceEventHandle AddTraceEvent(char phase,
  ...
  MicrosecondsInt64 now = GetMonoTimeMicros();
  return AddTraceEventWithThreadIdAndTimestamp(phase, category_group_enabled, name, id,
      thread_id, now, flags, arg1_name, arg1_val, arg2_name, arg2_val);
}
...
class TRACE_EVENT_API_CLASS_EXPORT ScopedTracer {
 public:
  ...
  void Initialize(const unsigned char* category_group_enabled, const char* name,
...
class TraceEventSamplingStateScope {
 public:
  ...
  static inline void Set(const char* category_and_name) {
    TRACE_EVENT_API_ATOMIC_STORE(
        g_trace_state[BucketNumber], reinterpret_cast<TRACE_EVENT_API_ATOMIC_WORD>(
...
class TraceScopedTrackableObject {
 public:
  TraceScopedTrackableObject(const char* category_group, const char* name, IDType id)
