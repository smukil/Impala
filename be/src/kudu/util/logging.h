...
#define KLOG_EVERY_N_SECS_THROTTLER(severity, n_secs, throttler, tag)     \
  ...
  google::LogMessage(__FILE__, __LINE__, google::GLOG_##severity,         \
      VARNAME_LINENUM(num_suppressed), &google::LogMessage::SendToLog)    \
      .stream()
...
#define KLOG_EVERY_N(severity, n)                                                        \
  GOOGLE_GLOG_COMPILE_ASSERT(                                                            \
      google::GLOG_##severity < google::NUM_SEVERITIES, INVALID_REQUESTED_LOG_SEVERITY); \
...
#define LOG_FIRST_N(severity, n)                                             \
  GOOGLE_GLOG_COMPILE_ASSERT(false, "LOG_FIRST_N is deprecated. Please use " \
                                    "KLOG_FIRST_N.")
