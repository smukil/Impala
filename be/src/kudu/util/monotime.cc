...
void MonoDelta::ToTimeVal(struct timeval* tv) const {
  ...
  // Catch positive corner case where we "round down" and could potentially set a timeout
  // of 0.
  // Make it 1 usec.
  ...
  // Catch negative corner case where we "round down" and could potentially set a timeout
  // of 0.
