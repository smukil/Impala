...
Status DoMaybeReturnFailure(double fraction, const Status& bad_status_to_return);
...
inline Status MaybeReturnFailure(double fraction, const Status& bad_status_to_return) {
