...
enum LogSeverity { SEVERITY_INFO, SEVERITY_WARNING, SEVERITY_ERROR, SEVERITY_FATAL };

// Callback for simple logging.
//
// 'message' is NOT terminated with an endline.
typedef Callback<void(LogSeverity severity, const char* filename, int line_number,
