...
class StringVectorSink : public google::LogSink {
 public:
  ...
  std::vector<std::string>& logged_msgs() { return logged_msgs_; }
...
struct ScopedRegisterSink {
  explicit ScopedRegisterSink(google::LogSink* s) : s_(s) { google::AddLogSink(s_); }
  ~ScopedRegisterSink() { google::RemoveLogSink(s_); }
